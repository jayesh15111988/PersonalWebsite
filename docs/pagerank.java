...
public class pagerank {
    ...
    public static void main(String args[])
    {
    	try
    	{
			...
			double differenceread=endreadtime-startreadtime;
		//	System.out.println("Time taken to read URLs from file (In milliseconds) "+differenceread);
		   ...
		   */
		   ...
		   double duration=0.0;
			...
			System.out.println("Time taken to perform pagerank calculation: (In milliseconds)"+duration);
	    	/*Java code to measure time required to complete program execution
	     	*Time is calculated in terms of nano-seconds
	     	*/
	     
		    //final long endTime1 = System.currentTimeMillis();
		   // final long duration1 = endTime - startTime;
		    //System.out.println("Run time for pagerank calculation is "+duration1);
		 ...
		 double writediff=endwritetime-startwritetime;
		 
		 System.out.println("Total I/O time taken by Sequential page rank alorithm is: "+(writediff+differenceread));
		    try
		    {
		    	if(output!=null)
		    	{	
