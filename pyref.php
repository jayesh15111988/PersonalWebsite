    	...
    	<div class="col_fw">
        	<div class="col_w460 float_l">
            	<h2>Acknowledgements</h2>
                           	<br/>
List of Sources and Acknowledgements for the text and codes used to build Games and Screensavers using Pygame Library
<br/><br/>
<p>
<ul class="tmo_list">
<li>http://mendel.informatics.indiana.edu/~yye/lab/teaching/fall2011-I210.php</li>
<li>http://cs.simpson.edu/?q=python_pygame_examples</li>
<li>http://docs.python.org/library/imageop.html</li>
<li>http://eli.thegreenplace.net/category/programming/python/pygame-tutorial/</li>

<li>http://www.pygame.org/wiki/tutorials</li>

<li>http://www.pythonware.com/library/pil/handbook/image.htm</li>
...
<br/><br/>
<b>Note</b><br/>
<em>Although I have tried to cite every reference, the list above is not exhaustive. Please let me know if I have used any source but missed to add it to the list above</em>            
            ...
            <div class="col_w460 float_r">
                ...
                <div class="col_w460">
                	<div class="fp_service_box fp_c1">
                        ...
                        <a href="copy.html"> Copyright</a>   View Copyright Notice</div>
                </div>
                <div class="col_w460">
                	<div class="fp_service_box fp_c2">
                       
                        <a href="sitemap.html"> Sitemap</a>
                        Get the overview of website on single page
					</div>
                </div>
				<div class="col_w460">
                	<div class="fp_service_box fp_c2">
                       
                        <a href="projects4.php#pygame"> Pygames</a>
                        Go back to Pygame Project Page
					</div>
                </div>
